...
class ReportViewTests(TestCase):
    def test_results_by_parent(self):
        ...
        acc_exp_subacc1 = Account.objects.create(
            name="expenses_subacc1",
            results=Account.RESULT_EXPENSES,
            parent=acc_exp_parent,
        )
        acc_exp_subacc2 = Account.objects.create(
            name="expenses_subacc2",
            results=Account.RESULT_EXPENSES,
            parent=acc_exp_parent,
        )
